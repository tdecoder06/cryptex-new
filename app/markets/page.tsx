...
//         Welcome to CRYPTEX — your trusted crypto trading platform.
//       </p>
//     </div>
//   );
// }
    ...
    return (
      <div>
        <div className="max-w-7xl mx-auto px-6 py-20">
            <h2 className="text-3xl font-bold mb-8 font-serif text-foreground">All Market Coins</h2>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-primary/5 text-muted text-sm uppercase tracking-wider bg-secondary/20">
                                ...
                                <th className="px-6 py-4 text-center font-medium">Exchange</th>
                            </tr>
                        </thead>
