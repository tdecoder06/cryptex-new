...
export const PickaxeIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M14.5 5.5l-4 4"></path>
        <path d="M16 3l5 5"></path>
        <path d="M3 21l9-9"></path>
        <path d="M12 13l5.5-5.5a2.12 2.12 0 0 1 3 3L15 16"></path>
    </svg>
);
...
export const FuelIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M14 13h-3v-3H9v3H6v-3H4v3H3v6h12v-6z"></path>
        <path d="M14 13V9a3 3 0 0 0-3-3h-2a3 3 0 0 0-3 3v4"></path>
        <path d="M15 22h4a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2h-2"></path>
    </svg>
);
...
export const CoinsIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M17.12 12.26A6 6 0 1 0 12 20a6 6 0 0 0 5.12-7.74z"></path>
    </svg>
);
