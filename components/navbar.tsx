...
//             <span className="text-green font-bold text-xl font-serif">♦️</span>
//           </div>
...
//           {["Home", "About us", "Markets", "Derivatives"].map((item) => (
//             <a
//               key={item}
//               href="#"
...
//         {/* Buttons: Connect Wallet (always) + Login/Logout (toggles) */}
//         <div className="flex items-center space-x-4">
//           {/* Connect Wallet - always visible */}
//           <button
//             onClick={connectWallet}
//             className="bg-primary text-white px-6 py-2 rounded-lg font-semibold hover:bg-primary/90 transition-all duration-200 transform hover:scale-105 shadow-lg shadow-primary/20"
//           >
//             {authenticated ? shortAddr(user?.wallet?.address) || "Wallet Connected" : "Connect Wallet"}
//           </button>
...
//                 : "bg-green-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-green-600 transition-all duration-200 transform hover:scale-105 shadow-lg shadow-green-400/20"
//             }
//           >
